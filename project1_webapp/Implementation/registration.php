...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (count($errors) === 0) {
        ...
        $stmt->bindParam(":username", htmlspecialchars($_POST["username"], ENT_QUOTES), PDO::PARAM_STR);        
        $stmt->bindParam(":password", password_hash($_POST["password"], PASSWORD_DEFAULT), PDO::PARAM_STR);
        $stmt->bindParam(":country", htmlspecialchars($_POST["country"], ENT_QUOTES), PDO::PARAM_STR);
        $stmt->bindParam(":city", htmlspecialchars($_POST["city"], ENT_QUOTES), PDO::PARAM_STR);
        $stmt->bindParam(":postalcode", htmlspecialchars($_POST["postalcode"], ENT_QUOTES), PDO::PARAM_STR);
        $stmt->bindParam(":street", htmlspecialchars($_POST["street"], ENT_QUOTES), PDO::PARAM_STR);
        $stmt->bindParam(":houseno", htmlspecialchars($_POST["houseno"], ENT_QUOTES), PDO::PARAM_STR);
        $stmt->bindParam(":firstname", htmlspecialchars($_POST["firstname"], ENT_QUOTES), PDO::PARAM_STR);
        $stmt->bindParam(":minit", htmlspecialchars($_POST["minit"], ENT_QUOTES), PDO::PARAM_STR);
        $stmt->bindParam(":lastname", htmlspecialchars($_POST["lastname"], ENT_QUOTES), PDO::PARAM_STR);
