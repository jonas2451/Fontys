...
insert into addresss values ('1', 'Germany', 'Dortmund', '44143', 'Klönnestraße', '89');
insert into addresss values ('2', 'Germany', 'Moers', '47445', 'Kopernikusstraße', '58');
insert into addresss values('3', 'Germany', 'Duesseldorf', '40210', 'Goethestraße', '2');
insert into addresss values ('4', 'Germany', 'Erkelenz', '41812', 'Maastrichterstraße', '4');
insert into customers values('1', 'Ring Police', 'Lukas', 'Luhr', 'info@ringpolice.de', '123wasd:68', '+49284112346', 'Sebastian', 'Stadler', '12345678', false, '2');
insert into customers values('2', 'JP Performance GMBH', 'JP', 'Kreamer', 'info@jpp.de', '123wa4d:68', '+4435682346', 'Sebastian', 'Kubik', '87654321', false, '1');
-- insert into orders values ('1', '2019-12-16', '1');
-- insert into orders values ('2', '2019-07-06', '2');
-- insert into orderproducts values ('1', 'Petrol', true, '50', '120', '2');
-- insert into orderproducts values ('2', 'Milk', false, '20', '90', '1');
-- insert into actions values ('1', 0, false, '50', '1', '2',null);
-- insert into actions values ('2', 0, true, '50', '1', '3', null);
-- insert into actions values ('3', 0, true, '20', '2', '2',null);
-- insert into actions values ('4', 0, false, '20', '2', '1',null);